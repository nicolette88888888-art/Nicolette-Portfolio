...
import { goalsContent } from '@/content/goals'
import { PaperStack } from '@/components/ui/PaperStack'

export const metadata = {
  title: 'Goals | The Creative Café',
}
  ...
  return (
    <section className="max-w-4xl mx-auto px-4 py-12 md:py-16">
      <header className="text-center mb-12">
        ...
        <h1 className="section-title mt-4">{goalsContent.headline}</h1>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {goalsContent.pillars.map((pillar, i) => (
